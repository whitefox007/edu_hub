...
type EduviCoursesDetailsFooterlogoOneProps = React.DetailedHTMLProps<
  React.HTMLAttributes<HTMLDivElement>,
  HTMLDivElement
> &
  Partial<{}>;

const EduviCoursesDetailsFooterlogoOne: React.FC<
  EduviCoursesDetailsFooterlogoOneProps
> = (props) => {
  return (
    <>
